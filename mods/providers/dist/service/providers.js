...
class ProvidersServer extends core_2.ResourceServer {
    async listProviders(call, callback) {
        const result = await super.listResources(core_1.Kind.GATEWAY, call);
    ...
    async getProvider(call, callback) {
        try {
            const result = await super.getResource(core_1.Kind.GATEWAY, call);
            callback(null, decoder_1.default(result));
        }
        catch (e) {
            callback(e, null);
    ...
    async deleteProvider(call, callback) {
        try {
            await super.deleteResource(core_1.Kind.GATEWAY, call);
