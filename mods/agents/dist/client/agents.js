...
exports.CommonPB = exports.AgentsPB = void 0;
 ...
 */
class Agents extends common_1.FonosService {
    /**
    ...
    async createAgent(request) {
        const agent = new agents_pb_1.default.Agent();
    ...
    async updateAgent(request) {
        const getAgentRequest = new agents_pb_1.default.GetAgentRequest();
    ...
    async listAgents(request) {
        logger_1.default.log("verbose", `@fonos/agents listAgent [request -> ${JSON.stringify(request)}]`);
